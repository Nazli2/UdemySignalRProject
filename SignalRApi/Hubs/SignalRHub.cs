...
public class SignalRHub : Hub
{
    ...
    public async Task SendStatistic()
    {
        ...
        var value5 = _productService.TProductCountByCategoryNameSalatalar();
        await Clients.All.SendAsync("ReceiveProductCountByCategoryNameSalatalar", value5);

        var value6 = _productService.TProductCountByCategoryNameTatlılar();
        await Clients.All.SendAsync("ReceiveProductCountByCategoryNameTatlılar", value6);
        ...
        var value10 = _productService.TProductAvgPriceBySalatalar();
        await Clients.All.SendAsync("ReceiveProductAvgPriceBySalatalar", value10.ToString("0.00") + "₺");
